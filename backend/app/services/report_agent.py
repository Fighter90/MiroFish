...
4. [Достоверное представление результатов прогноза]
   ...
   - Не добавляйте информацию, отсутствующую в симуляции
...
- Если информации достаточно: начните с "Final Answer:" и выведите содержимое раздела (обязательно цитируйте вышеуказанные оригинальные тексты)
...
REACT_INSUFFICIENT_TOOLS_MSG = (
    ...
    "Пожалуйста, вызовите ещё инструменты для получения дополнительных данных симуляции, затем выведите Final Answer. {unused_hint}"
)

REACT_INSUFFICIENT_TOOLS_MSG_ALT = (
    "Сейчас вызвано инструментов только {tool_calls_count} раз, минимум необходимо {min_tool_calls} раз."
    "Пожалуйста, вызовите инструменты для получения данных симуляции. {unused_hint}"
)

REACT_TOOL_LIMIT_MSG = (
    "Достигнут лимит вызовов инструментов ({tool_calls_count}/{max_tool_calls}), больше вызывать инструменты нельзя."
    'Пожалуйста, немедленно на основе полученной информации начните с "Final Answer:" и выведите содержимое раздела.'
)
...
REACT_FORCE_FINAL_MSG = "Достигнут лимит вызовов инструментов, пожалуйста, немедленно выведите Final Answer: и сгенерируйте содержимое раздела."
...
[Правила]
1. Приоритетно отвечайте на вопросы на основе содержания вышеуказанного отчёта
...
CHAT_OBSERVATION_SUFFIX = "\n\nПожалуйста, ответьте на вопрос лаконично."
...
class ReportAgent:
    ...
    def _generate_section_react(
        ...
        if response is None:
            ...
            final_answer = f"(Генерация этого раздела не удалась: LLM вернул пустой ответ, попробуйте позже)"
