  ...
  <div class="help-container">
    ...
    <div class="help-content">
      <div class="help-hero">
        ...
        <p class="help-subtitle">Всё, что нужно знать для работы с MiroFish</p>
      </div>
      ...
      <section id="about" class="help-section">
        ...
        <div class="section-body">
          <p>
            <strong>MiroFish</strong> — это движок коллективного интеллекта, который моделирует реакцию общества на любые события. Система создаёт виртуальный мир из тысяч AI-агентов, каждый из которых обладает уникальной личностью, памятью и социальными связями.
          </p>
          <div class="feature-grid">
            <div class="feature-card">
              <div class="feature-icon">◈</div>
              <div class="feature-title">Прогнозирование</div>
              <div class="feature-desc">Моделирование общественной реакции на события, решения и новости до их реального наступления</div>
            </div>
            <div class="feature-card">
              <div class="feature-icon">◇</div>
              <div class="feature-title">Граф знаний</div>
              <div class="feature-desc">Автоматическое извлечение сущностей и связей из ваших документов для построения реалистичной модели мира</div>
            </div>
            <div class="feature-card">
              <div class="feature-icon">▣</div>
              <div class="feature-title">Мультиплатформенность</div>
              <div class="feature-desc">Параллельная симуляция на двух платформах (Twitter и Reddit) для более полной картины</div>
            </div>
            <div class="feature-card">
              <div class="feature-icon">⬡</div>
              <div class="feature-title">Глубокий анализ</div>
              <div class="feature-desc">Аналитический отчёт и возможность диалога с каждым агентом после симуляции</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="section-body">
          ...
          <div class="step-block">
            ...
            <div class="step-content">
              <h3>Загрузите документы — «Зёрна реальности»</h3>
          ...
          <div class="step-block">
            ...
            <div class="step-content">
              <h3>Нажмите «Запустить движок»</h3>
      ...
      <section id="workflow" class="help-section">
        ...
        <div class="section-body">
          ...
          <div class="workflow-card">
            ...
            <div class="wf-body">
              <p>На основе графа знаний система генерирует AI-агентов — виртуальных участников с уникальными характеристиками:</p>
              <ul>
                <li><strong>Личность</strong> — имя, возраст, профессия, ценности</li>
                <li><strong>Память</strong> — контекстные знания из документов</li>
                <li><strong>Социальные связи</strong> — отношения между агентами</li>
              </ul>
          ...
          <div class="workflow-card">
            ...
            <div class="wf-body">
              <p>Агенты начинают взаимодействовать на двух виртуальных платформах одновременно:</p>
              <ul>
                <li><strong>Twitter</strong> — короткие публикации, ретвиты, лайки, комментарии</li>
                <li><strong>Reddit</strong> — развёрнутые обсуждения, треды, голосования</li>
              </ul>
          ...
          <div class="workflow-card">
            ...
            <div class="wf-body">
              <p>После завершения симуляции открываются возможности глубокого анализа:</p>
              <ul>
                <li><strong>Чат с отчётом</strong> — задавайте уточняющие вопросы по результатам</li>
                <li><strong>Интервью с агентами</strong> — разговаривайте напрямую с участниками симуляции, узнавайте их мотивы и мнения</li>
      ...
      <div class="help-footer">
        ...
        <p>MiroFish v0.1 — Движок коллективного интеллекта</p>
...
const faqs = [
  { q: 'Какие LLM поддерживаются?', a: 'MiroFish работает с любым LLM через OpenAI-совместимый API. Рекомендуются: Qwen, GPT-4, Claude, Mistral. Настройка производится через переменные окружения LLM_API_KEY, LLM_BASE_URL и LLM_MODEL_NAME.' },
  ...
  { q: 'Что такое ZEP и зачем он нужен?', a: 'ZEP — это сервис памяти для AI-агентов. Он обеспечивает долговременную память агентов между раундами симуляции, что делает их поведение более реалистичным. Бесплатного тарифа на getzep.com достаточно для базового использования.' },
  ...
  { q: 'Почему две платформы (Twitter и Reddit)?', a: 'Разные платформы моделируют разные типы общения: Twitter — быстрые реакции и вирусное распространение, Reddit — глубокие дискуссии и аргументированные мнения. Вместе они дают более полную картину.' },
