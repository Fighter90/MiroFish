        ...
        <div class="section-body">
          ...
          <div class="feature-grid">
            ...
            <div class="feature-card">
              ...
              <div class="feature-desc">Параллельная симуляция на двух платформах (Twitter и Reddit) для охвата различных коммуникативных моделей</div>
            </div>
            <div class="feature-card">
              <div class="feature-icon">⬡</div>
      ...
      <section id="workflow" class="help-section">
        ...
        <div class="section-body">
          ...
          <div class="workflow-card">
            ...
            <div class="wf-body">
              <p>Агенты взаимодействуют на двух симулированных платформах одновременно:</p>
              <ul>
...
const faqs = [
  ...
  { q: 'Почему две платформы (Twitter и Reddit)?', a: 'Платформы моделируют различные коммуникативные паттерны: Twitter — короткие реакции и вирусное распространение, Reddit — развёрнутые дискуссии и аргументированные позиции. Комбинация обеспечивает более полный охват общественного мнения.' },
