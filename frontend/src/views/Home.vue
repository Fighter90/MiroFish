<template>
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <!-- Нижняя часть: двухколоночная компоновка -->
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            ...
            <div class="metric-card">
              ...
              <div class="metric-label">Параллельная симуляция на двух социальных платформах</div>
            </div>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Параллельное моделирование на двух социальных платформах: публикации, комментарии, голосования, подписки</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="Опишите сценарий моделирования, например: Правительство объявило о переходе на четырёхдневную рабочую неделю. Как отреагируют различные социальные группы?"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Запуск моделирования — мгновенный переход, вызов API происходит на странице Process
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Мгновенный переход на страницу Process (специальный идентификатор для нового проекта)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Space Grotesk используется как основной шрифт для заголовков, JetBrains Mono — для кода/меток.
...
/* Двухколоночная компоновка Dashboard */
.dashboard-section {
  display: flex;
  gap: 60px;
...
/* Активное состояние (не заблокировано) */
